...
При любом изменении (загрузка, создание, редактирование) GitHub просит **подтвердить изменения** — это называется *коммит* (commit). Достаточно оставить вариант **Commit directly to the `main` branch** (сохранить сразу в основную ветку) и нажать зелёную кнопку **Commit changes**.
