...
2. Нажать на кнопку «Начать проект»
3. Предоставить доступ к Гитхабу. Это нужно для автоматического создания репозитория проекта и его интеграции с Хекслетом
4. Перейти в первому шагу и начать выполнять задание
