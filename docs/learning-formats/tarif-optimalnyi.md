...
Для удобства общения между студентами и поддержки в организационных вопросах мы создаем закрытые групповые чаты с [куратором](/docs/learning-process/kurator.md), где также есть и [наставник](/docs/learning-process/nastavnik.md) для оперативной помощи с вопросами по урокам.
