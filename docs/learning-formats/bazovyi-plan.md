...
Если формат подписки для вас не очень удобен, можно подключить Базовый план сразу на 1 или 3 года на странице [Подписка](https://ru.hexlet.io/subscription/new).