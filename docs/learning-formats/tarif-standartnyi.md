...
Обучаясь в этом формате, студенты самостоятельно изучают [профессии](/docs/getting-started/chto-takoe-professii-v-hekslete.md) без постоянной поддержки наставника (на этом тарифе доступна профессия Java-разработчик). Тариф «Стандартный» подходит тем, кто любит разбираться во всех нюансах без чьей-либо помощи, но хотел бы получать дополнительную проверку итоговых проектов от опытного разработчика.
