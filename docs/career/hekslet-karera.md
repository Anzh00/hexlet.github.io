...
Участие в карьерном центре доступно для студентов на тарифах **«Стандартный»**, **«Оптимальный»**, **«Расширенный»** и **«Премиальный»**, обучающихся в [асинхронном формате.](/docs/formats-and-tarifs/formats/asinhronnyi-format.md) Состав карьерных услуг зависит от тарифа:

- на тарифе [«Стандартный»](/docs/formats-and-tarifs/tarifs/tarif-standartnyi.md) доступны Telegram-сообщество, закрытый курс с ревью резюме и сопроводительных писем, помощь с оформлением рабочих профилей и вакансии компаний-партнёров;

- на тарифах [«Оптимальный»](/docs/formats-and-tarifs/tarifs/tarif-optimalnyi.md) и [«Расширенный»](/docs/formats-and-tarifs/tarifs/tarif-rasshirennyi.md) к этому добавляются практика в коммерческих проектах, мок-собеседование с наставником и soft-skill собеседование с HR-специалистом;

- на тарифе [«Премиальный»](/docs/formats-and-tarifs/tarifs/tarif-premialnyi.md) дополнительно доступны персональная консультация с HR-специалистом с составлением PDP и рекомендации в компании-партнёры.
