...
**Решение учителя** доступно **в меню справа** (кнопка "Подсказка") в каждом упражнении. Оно предназначено для того, чтобы студент мог подсмотреть готовое решение, если застрял и не может продвинуться дальше.
