...
Посмотреть решение учителя можно на странице с [сохраненным решением](/docs/practice/kak-sohranit-svoe-reshenie.md). Решение становится доступно через 20 минут после того, как вы зашли в упражнение.
