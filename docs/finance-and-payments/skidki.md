...
- За отзыв о Хекслете можно получить дни доступа по Базовому плану, либо продление Оптимального/Премиального тарифа, если вы уже учитесь на них. Подробные условия [здесь](/docs/site-and-platform/kak-ostavit-otzyv-o-hekslete.md).
