...
После активации промокода у принявшего подарок будет открыт доступ ко всем курсам из раздела [Подписка](https://ru.hexlet.io/courses_subscription) с онлайн-тренажёром и практическими проектами, как это происходит при оформлении ежемесячной подписки на [Базовый план](/docs/learning-formats/bazovyi-plan.md).
