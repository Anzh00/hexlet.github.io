...
Скидка 50% на [Базовый план](/docs/learning-formats/bazovyi-plan.md) для участников акции пожизненная, вы можете воспользоваться ей в любой удобный момент. Для того, чтобы получить скидку, напишите нам на почту support@hexlet.io.
