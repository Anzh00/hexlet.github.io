...
Чтобы создавать истории успеха, редакция Хекслета брала у студентов интервью, которое потом мы превращали в текст. А взамен на рассказ выпускники получали 30 дней доступа для самостоятельного обучения в Хекслете и пожизненную скидку 50% на [Базовый план](/docs/learning-formats/bazovyi-plan.md).
...
Скидка 50% на [Базовый план](/docs/learning-formats/bazovyi-plan.md) для участников акции пожизненная, вы можете воспользоваться ей в любой удобный момент. Для того, чтобы получить скидку, напишите нам на почту support@hexlet.io, и ребята отправят нужную ссылку.

Со временем ссылка становится неактивной, для повторной активации также нужно написать на почту support@hexlet.io, чтобы ребята ее «оживили».
