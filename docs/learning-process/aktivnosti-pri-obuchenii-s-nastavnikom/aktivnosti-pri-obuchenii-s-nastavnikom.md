...
темы для будущих мероприятий. Вся информация про обучение находится в разделе «[Дашборд](https://ru.hexlet.io/my)».

## Про календарь

Расписание мероприятий ведётся в сервисе **Яндекс.Календарь** и отображается на странице «[Дашборд](https://ru.hexlet.io/my)». 
...
Дополнительно каждую неделю по понедельникам в Telegram-чат группы (тема "Активности с наставником") отправляется сообщение с планом активностей.
...
- в разделе «Полезные ссылки» на странице «[Дашборд](https://ru.hexlet.io/my)»

- в учебном чате в теме General
...
Вы тоже можете предложить тему! Для этого есть анкета «**Запрос тем на активности**». Её можно найти в сообщении «Как прошло мероприятие?», которое отправляется в Telegram-чат после любой активности.
