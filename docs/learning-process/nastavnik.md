...
- отвечает на вопросы студентов в тематических Telegram-чатах;
...
Перед началом занятий студентов добавляют в закрытый канал в Telegram, где происходит основное общение: наставник отвечает на вопросы в течение 3 часов в будние дни, без ограничения их количества.

В рамках обучения регулярно проводятся вебинары — желательно участвовать лично, но если не получается, не страшно: материалы будут доступны в записи.

## Обучение на Премиальном

Если учитесь в этом формате, наставник:

- отвечает на вопросы по выбранному направлению;
- проверяет проекты и даёт рекомендации по их рефакторингу;
