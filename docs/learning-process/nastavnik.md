...
Перед началом занятий студентов добавляют в закрытый канал в Telegram, где происходит основное общение: наставник отвечает на вопросы 1–2 раза в будние дни, без ограничения их количества.
