...
**Видеоотзыв** можно отправить на почту support@hexlet.io. К письму можно прикрепить сам файл или ссылку на загруженное видео (YouTube, Google Drive, Яндекс.Диск, Mail.ru Облако и др.). А о требованиях к видеоотзыву рассказываем в статье [Как записать видеоотзыв](/docs/site-and-platform/bonusy-za-otzyvy/kak-zapisat-videootzyv/kak-zapisat-videootzyv.md).
