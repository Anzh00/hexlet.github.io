...
- Для вывода кода в тексте оберните код `` `бэк-тиками` `` 
  ...
  Несколько строк кода нужно выводить блоком. Для этого оберните код тройными тиками и укажите язык, на котором написан код. Например:
   ...
   ` ``` ` 
  Вот часть языков, которые можно использовать: go, javascript, typescript, python, php, java. Полный список можно увидеть здесь: https://highlightjs.org/demo
...
- Для того, чтобы сделать вложенный список, используйте отступ в три или больше пробелов.
  ```
  - item a  
  - item b
     1. item one  
