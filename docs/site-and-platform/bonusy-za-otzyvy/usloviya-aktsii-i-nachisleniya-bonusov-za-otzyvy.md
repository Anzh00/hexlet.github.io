...
1.4. Для активации бонуса по подписке на Базовый план, студент получает промокод, который можно активировать в разделе [Промокод](https://ru.hexlet.io/account/promo_codes/new).
