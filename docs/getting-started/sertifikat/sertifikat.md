...
- Вы обучаетесь на тарифе «[Оптимальный](/docs/learning-formats/tarif-optimalnyi.md)»,, «[Стандартный](/docs/learning-formats/archived-formats/tarif-standartnyi.md)», [Расширенный](/docs/learning-formats/tarif-rasshirennyi.md) или «[Премиальный](/docs/learning-formats/tarif-premialnyi.md)»
...
Сертификат не выдаётся за прохождение бесплатных курсов и при обучении по подписке.
